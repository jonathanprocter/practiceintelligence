  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Right side - Metrics HORIZONTALLY arranged like your app */}
        <div style={{
          display: 'flex',
          alignItems: 'center',
          gap: '40px'
          ...
          return (
            <div
              ...
              style={{
                display: 'flex',
                minHeight: '44px',
                backgroundColor: slot.isTopOfHour ? '#f3f4f6' : '#ffffff', // Grey for top of hour, white for half hour
            ...
            >
              ...
              <div style={{
                ...
                fontWeight: '500',
                color: '#374151',
                backgroundColor: 'transparent', // Use transparent to inherit row background
